...
class Version20130930180819_Init extends AbstractMigration
{
    ...
    {
        $this->addSql('INSERT INTO "storage" VALUES(1,"Local","Storage on local computer","folder","/home/user/")');
        // add sequence
